...
export function SettingsForm({ admin, village }: { admin: AdminMe; village: AdminVillage }) {
  ...
  return <div className="space-y-6">
    ...
    <form onSubmit={save} onChange={(event) => {
      ...
      <section data-guide="settings-account" className="ui-panel p-5 sm:p-6"><Header icon={UserRound} title="Akun" description="Identitas penanggung jawab desa." /><div className="mt-5 grid gap-4 sm:grid-cols-2">
      ...
      <section data-guide="settings-village" className="ui-panel p-5 sm:p-6"><Header icon={CheckCircle2} title="Profil Desa" description="Data wajib untuk aktivasi dan kop dokumen laporan." /><div className="mt-5 grid gap-4 sm:grid-cols-2">
