...
export function ReportDocumentsPanel({ reportId, disabled = false }: { reportId: string; disabled?: boolean }) {
  ...
  useEffect(() => {
    if (!items.some((document) => document.status === "pending")) return;
