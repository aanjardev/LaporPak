...
export function ReportsNav({ showKnowledge }: { showKnowledge: boolean }) {
  ...
  return (
    <nav aria-label="Navigasi utama" className="mt-5 lg:mt-10">
      <Link href="/reports" aria-current={!knowledgeActive ? "page" : undefined} className={`flex min-h-11 items-center gap-3 rounded-lg px-3 text-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-700 ${!knowledgeActive ? activeClass : idleClass}`}>
