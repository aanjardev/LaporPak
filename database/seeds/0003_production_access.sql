...
values
    ('29b2bc8e-6afe-4368-8298-60390eed0b14', 'system_admin', 'Anjar', true),
...
-- Temporary trusted channel identifier for the shared demo environment.
-- Replace this row with the real Meta WhatsApp Phone Number ID before public use.
